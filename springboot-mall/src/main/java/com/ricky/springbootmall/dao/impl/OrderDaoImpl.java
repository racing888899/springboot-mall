...
import com.ricky.springbootmall.rowmapper.OrderItemRowMapper;
import com.ricky.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        String sql = "SELECT oi.order_item_id, oi.order_id, " +
                "oi.product_id, oi.quantity, oi.amount, p.product_name, " +
...
//            map.put("quantity", orderItem.getProductId());
